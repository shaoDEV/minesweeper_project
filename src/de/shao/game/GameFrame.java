...
public class GameFrame extends JFrame {
    ...
    private GameBoardBackground backgroundLayer = new GameBoardBackground();
    private JPanel gameLayer = new GameBoard(this, backgroundLayer);

    GameFrame(){
        this.setSize(new Dimension(663,630));
        this.setUndecorated(true);
        this.setLocationRelativeTo(null);
        this.setBackground(new Color(1.0f, 1.0f, 1.0f, 0.0f));

        lPane.setBounds(0,0,663,630);
